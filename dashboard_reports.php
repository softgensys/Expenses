...
if ($from!='' && $to!='' && $trans_type!='') {
    $sub_sql.=" and exp.expenses_date between '$from' and '$to' and exp.trans_type='$trans_type'";
}
            ...
            <div class="row">
                ...
                <form method="get">
                 <div class="form-group row">
                       ...
                       <div class="form-group row">
                        <label class="col-form-label col-auto mb-1">Type:</label>
                         <div class="col-auto">
                             <b><input type="text" name="trans_type" style="color: <?php echo ($trans_type == 'Income') ? 'green' : (($trans_type == 'Expense') ? 'red' : 'black'); ?>; font-size:'1rem'"
                             class="form-control" required readonly value="<?php echo $trans_type; ?>"></b>
                        </div>
                 </div>
                </form>
</div>
